      ...
      <div className="bg-white p-4 my-4 rounded-lg shadow">
        {currentUser?.class || currentUser?.roll ? (
          <p className="text-gray-800 font-semibold mb-2">
            Student in class {currentUser?.class || "N/A"} at Golbunia Nesaria Dakhil Madrasah. Roll no.
            {currentUser?.roll || "N/A"}
          </p>
        ) : (
          <p>Student in class N/A at Golbunia Nesaria Dakhil Madrasah. Roll no. N/A</p>
        )}
