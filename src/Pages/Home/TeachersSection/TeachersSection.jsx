...
const TeachersSection = () => {
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="w-6/12 mx-auto py-3 my-10 bg-green-500">
        <h1 className="text-2xl text-center uppercase">MEET OUR TEACHERS</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {dataToShow.map((teacher) => (
          <div
            key={teacher.id}
            className="bg-white text-gray-800 hover:bg-green-500 hover:text-white rounded-lg shadow-md p-6"
          >
            ...
            <div className="mt-2">
              ...
              <div className="flex justify-start items-center gap-1">
                ...
                <span className="">{teacher.mobileNumber}</span>
              </div>
            </div>
          </div>
        ))}
