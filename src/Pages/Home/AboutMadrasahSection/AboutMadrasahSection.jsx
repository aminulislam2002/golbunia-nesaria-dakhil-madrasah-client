...
const AboutMadrasahSection = () => {
  ...
  return (
    <div className="container mx-auto py-10 lg:py-20 px-3 bg-gray-100">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
        <div className="md:col-span-8 shadow-md p-5">
          ...
          <div>
            ...
            <div>
              <p className="text-lg  text-justify">
                <span className="font-bold">Overview:</span> Golbunia Nesaria Dakhil Madrash is an educational establishment
                that is located at Shafabandar Bhandaria Pirojpur. Its Educational Institute Identification Number or ElIN,
                is 102671. On 01 January, 1984, it was first put into operation. The alternative name for Golbunia Nesaria
                Dakhil Madrasah is o lis a Combined sort of co-educational program. The institution provides education in the
                following fields: Humanities, Business Studies, Science. Its MPO number is 5402082106. It operates on Day
                shifts. Its management is Managing. Its recognition is Recognized by the government and the recognition level
                is Dakhil. The school/college has MPO level with MPO number 5402082106 and the MPO type is Yes. The Madrasah
                is under Madrasah Education Board. While many other high schools teach numerous disciplines, you can find the
                major disciplines that they teach in this high school as Humanities, Business Studies, Science. The
                management type of this institute is Managing. The region in which it is located is Grameen with geographic
                location as Plain Land. The institute is in the constituency no 128.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-4">
          ...
          <div className=" shadow-md py-3">
            <img src={principal} className="w-48 h-48 mx-auto border-4 border-green-500 mt-3-3" alt="Principal's Photo" />
